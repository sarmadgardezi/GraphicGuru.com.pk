<nav x-data="{ open: false }" class="bg-brand-black border-b border-white/10 sticky top-0 z-50">
        ...
        <div class="flex justify-between h-20 items-center">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(url('/')); ?>" class="text-3xl font-black italic tracking-tighter text-brand-lime hover:scale-105 transition-transform uppercase">
                        GraphicGuru
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:ml-12 sm:flex">
                    <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-white hover:text-brand-lime transition duration-150 ease-in-out">
                        Solutions & Services
                    </a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-brand-black border-t border-gray-800 transition">
        <div class="pt-2 pb-3 space-y-1">
            <a href="<?php echo e(url('/')); ?>" class="block w-full pl-3 pr-4 py-2 text-left text-base font-medium text-brand-lime bg-gray-900 border-l-4 border-brand-lime focus:outline-none transition duration-150 ease-in-out">
                Home
            </a>
...
<?php /**PATH /Users/sarmadgardezi/Documents/GitHub/GraphicGuru.com.pk/resources/views/components/navbar.blade.php ENDPATH**/ ?>